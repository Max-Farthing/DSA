...
public class SeparateChainingHashMapTest {
    ...
    public void testPut() {
        ...
        assertNull(map.put(10, "string10")); //collisions added
        ...
        assertEquals(17, (int)it.next().getKey()); // should be in a map in index 4
        assertEquals(4, (int)it.next().getKey()); // should be in a map in index 5
    ...
    public void testGet() {
        ...
        assertEquals("string4", map.put(4, "string40")); //overwriting KV pair
        assertEquals(2, map.size());
        assertEquals("string40", map.get(4));

        assertNull(map.put(10, "string10")); //collisions added
        assertEquals(3, map.size());
        assertEquals("string10", map.get(10));

        assertNull(map.put(11, "string11")); //collision
        assertEquals(4, map.size());
        assertEquals("string11", map.get(11));

        assertEquals("string40", map.get(4)); //stays same after collision
        assertEquals("string10", map.get(10));
        assertEquals("string3", map.get(3));

        assertNull(map.get(28));
    }
    ...
    public void testEntrySet() {
        ...
        Iterator<Map.Entry<Integer, String>> it = map.entrySet().iterator();  //testing keys      
        ...
        assertEquals("string10", it.next().getValue());
    ...
    public void testConstructors() {
    	...
    	map = new SeparateChainingHashMap<Integer, String>(10);
