...
public class HeapAdaptablePriorityQueueTest {
	/** adaptable priority heap for testing */
    ...
    public void testReplaceKey() {
        ...
        heap.replaceKey(e8,  -1);
        assertEquals(-1, (int)heap.min().getKey());
        assertEquals("eight", heap.min().getValue());
        assertEquals(9, heap.size());
        
        heap.replaceKey(e7, 22);
        assertEquals(22, (int)e7.getKey());
        assertEquals("eight", heap.min().getValue());
        assertEquals(9, heap.size());
        
        heap.replaceKey(e6, 12);
        assertEquals(12, (int)e6.getKey());
        assertEquals("eight", heap.min().getValue());
        assertEquals(9, heap.size());
