...
public class AdjacencyListGraph<V, E> extends EdgeListGraph<V, E> {
    ...
    public Edge<E> insertEdge(Vertex<V> vertex1, Vertex<V> vertex2, E edgeData) {
    	...
    	ALVertex o = validate(vertex1);
    	ALVertex d = validate(vertex2);
    	Edge<E> e = super.insertEdge(vertex1, vertex2, edgeData);
    	Position<Edge<E>> pos = o.getOutgoing().addLast(e);
    	Position<Edge<E>> pos2 = d.getIncoming().addLast(e);
    	((ALEdge)e).setIncomingListPosition(pos2);
    	((ALEdge)e).setOutgoingListPosition(pos);
    	return e;
    }
    ...
    public void removeEdge(Edge<E> edge) {
    	...
    	ALVertex o = validate(v[0]);
    	ALVertex d = validate(v[1]);
    	
    	Position<Edge<E>> e1 = e.getIncomingListPosition();
    	d.getIncoming().remove(e1);
    	
    	Position<Edge<E>> e2 = e.getOutgoingListPosition();
    	o.getOutgoing().remove(e2);
