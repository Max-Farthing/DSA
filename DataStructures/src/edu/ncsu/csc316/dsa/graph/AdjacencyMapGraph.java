...
public class AdjacencyMapGraph<V, E> extends EdgeListGraph<V, E> {
    ...
    public Edge<E> getEdge(Vertex<V> vertex1, Vertex<V> vertex2) {
    	AMVertex a1 = validate(vertex1);
    	AMVertex a2 = validate(vertex2);
    	Map<Vertex<V>, Edge<E>> m = a1.getIncoming();
    	Edge<E> e = m.get(a2);
    	return e;
    }
    ...
    public Iterable<Edge<E>> incomingEdges(Vertex<V> vertex) {
    	AMVertex a1 = validate(vertex);
    	return super.incomingEdges(a1);
    }

    @Override
    public int inDegree(Vertex<V> vertex) {
    	AMVertex a1 = validate(vertex);
    	return super.inDegree(a1);
    }
    ...
    public Edge<E> insertEdge(Vertex<V> v1, Vertex<V> v2, E edgeData) {
    	...
    	d.getOutgoing().put(o, e);
    	o.getIncoming().put(d, e);
    	return e;
    }
    ...
    public int outDegree(Vertex<V> vertex) {
    	AMVertex a1 = validate(vertex);
    	return super.outDegree(a1);
    }

    @Override
    public Iterable<Edge<E>> outgoingEdges(Vertex<V> vertex) {
    	AMVertex a1 = validate(vertex);
    	return super.outgoingEdges(a1);    
    }
    ...
    public void removeEdge(Edge<E> edge) {
    	...
    	AMVertex o = validate(v[0]);
    	AMVertex d = validate(v[1]);
