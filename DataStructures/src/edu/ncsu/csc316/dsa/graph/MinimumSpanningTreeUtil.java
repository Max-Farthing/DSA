...
public class MinimumSpanningTreeUtil {
    ...
    public static <V, E extends Weighted> PositionalList<Edge<E>> kruskal(Graph<V, E> g) {
    	PositionalLinkedList<Edge<E>> t = new PositionalLinkedList<Edge<E>>();
    	HeapAdaptablePriorityQueue<Integer, Edge<E>> pq = new HeapAdaptablePriorityQueue<Integer, Edge<E>>();
