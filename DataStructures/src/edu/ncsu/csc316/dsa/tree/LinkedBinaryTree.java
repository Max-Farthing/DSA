...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
    ...
    public Position<E> addLeft(Position<E> p, E value) {
        ...
        BinaryTreeNode<E> nodeLeft = createNode(value, node, null, null);
    ...
    public Position<E> addRight(Position<E> p, E value) {
        ...
        BinaryTreeNode<E> nodeRight = createNode(value, node, null, null);
    ...
    public E remove(Position<E> p) {
        ...
        boolean isLeftChild = (parent != null && parent.getLeft() == node);

        // Determine the child (if any) of the node to be removed
        BinaryTreeNode<E> child = (node.getLeft() != null) ? node.getLeft() : node.getRight();

        // Update the parent's reference to point to the child (or null if it's a leaf node)
        if (parent != null) {
            if (isLeftChild) {
        ...
        // Update the child's parent reference (if it's not null)
        if (child != null) {
