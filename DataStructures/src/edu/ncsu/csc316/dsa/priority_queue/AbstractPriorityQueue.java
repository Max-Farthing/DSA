...
public abstract class AbstractPriorityQueue<K extends Comparable<K>, V> implements PriorityQueue<K, V> {
	/** comparator object to compare two entries */
    ...
    public class NaturalOrder implements Comparator<K> {
    	/**
    	 * comparison method used for comparing two entries
    	 * @param first - the first key for comparison
    	 * @param second - the second key for comparison
    	 * @return int based upon the order of comparison
    	 */
    ...
    public static class PQEntry<K, V> implements Entry<K, V> {
    	/** key inside of PQ entry */
        private K key;
        /** value inside of PQ entry */
        private V value;
