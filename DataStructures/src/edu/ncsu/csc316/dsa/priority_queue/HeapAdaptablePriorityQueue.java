...
public class HeapAdaptablePriorityQueue<K extends Comparable<K>, V> extends HeapPriorityQueue<K, V>
    ...
    /**
     * Converts entry to appropriate adaptable entry to be used in this heap implementation
     * @param entry provided entry to be converted
     * @return an instance of the adaptable entry
     */
    ...
    /**
     * bubble method to help determine whether a upHeap or downHeap are neccessary
     * @param index index of the entry in question
     */
