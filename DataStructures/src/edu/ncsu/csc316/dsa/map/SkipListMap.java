...
public class SkipListMap<K extends Comparable<K>, V> extends AbstractOrderedMap<K, V> {
    ...
    public V get(K key) {
        ...
        // Check if the key was found in the skip list
        if (node != null) {
        ...
        // Key not found in the skip list; return null
        return null;
    }
    ...
    public V put(K key, V value) {
        ...
        if (p.getEntry() != null && p.getEntry().getKey().equals(key)) {
        ...
        do {
            ...
            while (p != null && p.getAbove() == null) {
                p = p.getPrevious();
            }
            
            if(p != null && p.getAbove() != null) {
                p = p.getAbove();
            }
    ...
    public V remove(K key) {
        ...
        // If the entry with the key exists, remove it and return its value
        if (p.getEntry() != null && p.getEntry().getKey().equals(key)) {
            V removedValue = p.getEntry().getValue();
        ...
        // If the entry with the key does not exist, return null
        return null;
    }
